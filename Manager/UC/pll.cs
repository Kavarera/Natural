    ...
    public partial class pll : UserControl
    {
        ...
        private void button5_Click(object sender, EventArgs e)  //Button Ubah
        {
            if (pllDGV.SelectedRows.Count > 0)
            {
                ...
                satuanTB.Text = pllDGV.SelectedRows[0].Cells[3].Value.ToString();
                ...
                MessageBox.Show(pllDGV.CurrentCell.ToString(), pllDGV.CurrentCell.Value.ToString());
                simpanBTN.Enabled = true;
        ...
        {
            if (namatransaksiTB.Text != "" && jumlahTB.Text != "" && targettransaksi_TB.Text != "" && satuanTB.Text != "" && hargasatuanTB.Text != "")
            {
                sdt.Rows.Add();
                ...
                sdt.Rows[sdt.Rows.Count - 1]["Satuan"] = satuanTB.Text;
